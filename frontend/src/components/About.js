          ...
          <div className=" bg-white ">
            <div className="container">
              <p className="pt-2">
                ...
                Palakkad! Started as a bunch of friends interested in adventures
                now we have a dedicated team and over 200 student members, who
                are passionate about exploring the breathtaking beauty of the
                Western Ghats and organizing thrilling treks and adventures for
                our members.
              </p>

              <p>
                At Novare, we believe in the transformative power of nature and
                adventure. We strive to provide unforgettable experiences that
                not only challenge our members physically but also nurture a
                deep appreciation for the natural wonders around us. Through our
                treks and adventures, we aim to inspire a sense of adventure,
                foster camaraderie, and promote a sustainable approach to
                outdoor exploration.
              </p>
              <p>
                ...
                offer a range of trekking options to suit different skill levels
                and preferences. Each trek is carefully crafted to showcase the
                natural beauty of the region and provide opportunities for
              ...
              <p className="mb-0">
                ...
                lifelong friendships, and connecting with nature in ways you've
                never imagined. Get ready to challenge yourself, explore the
                Western Ghats, and create memories that will last a lifetime.
              </p>
            </div>
          </div>
        </div>
